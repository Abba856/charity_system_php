...
<body>
    ...
    if(isset($_POST['submit'])){
        ...
        $stmt->bind_param("ssssss", $name, $gender, $phone, $email, $category, $amount);
        
        if($stmt->execute()){
            $message = "Thank you $name, your donation has been received. May Almighty Allah reward you with your desire.";
        } else {
    ...
    <main class="main-content">
        <div class="container">
            <div class="card form-container">
                ...
                <form method="POST" action="donates.php">
